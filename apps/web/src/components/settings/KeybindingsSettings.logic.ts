...
export function commandLabel(command: KeybindingCommand): string {
  ...
  if (command === "thread.editQueuedMessage") return "Queue: Edit Previous Queued Message";
  if (command === "thread.editNextQueuedMessage") return "Queue: Edit Next Queued Message";
